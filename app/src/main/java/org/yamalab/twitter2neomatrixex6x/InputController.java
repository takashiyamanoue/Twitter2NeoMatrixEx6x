...
implements OnClickListener
{
	...
	private View mToArduinoButton = findViewById(R.id.button_to_arduino);
	private View mToTwitterButton = findViewById(R.id.button_to_twitter);
...
//		mAdk2WikiView = (EditText) findViewById(R.id.input_adk_to_wiki_area);
		...
		TextView mA2v = (TextView) findViewById(R.id.a2v);
		mA3v=(TextView) findViewById(R.id.a3v);
		TextView mA4v = (TextView) findViewById(R.id.a4v);
		...
		Button md1b = (Button) findViewById(R.id.d1b);
		md2b=(Button) findViewById(R.id.d2b);
		md3b=(Button) findViewById(R.id.d3b);
		Button md4b = (Button) findViewById(R.id.d4b);
